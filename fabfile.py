...
def project():
    ...
    env.python3_use = True
    env.python3_url = 'https://www.python.org/ftp/python/3.4.1/Python-3.4.1.tar.xz'
    env.python3_ver = 'Python-3.4.1'
    ...
    env.requirements_file = join(env.code_root, 'requirements')
